...
## Question 7a: What challenges did you encounter or anticipate encountering as you continue to build / iterate on your visualizations in R? If you struggled with mocking up any of your three visualizations (from #6, above), describe those challenges here.
    ...
    Viz 1: I didn't anticipate as many issues with defining the bboxes for viz 1. Going through by hand to define them all is a bit of a pian, so I'm all ears to finding an easier way to do this. Additionally, some of my data keeps disappearing so I am actively troubleshooting that. 
